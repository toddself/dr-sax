...
test('ordered lists', function(t){
  ...
  t.equal(output, '1. this is the first\n1. this is the second\n\n\n', 'ordered lists');
  t.end();
});
...
test('unordered lists', function(t){
  ...
  t.equal(output, '* this is the first\n* this is the second\n\n\n', 'ordered lists');
  t.end();
});
...
test('blockquote', function(t){
  ...
  t.equal(output, '> I am a little teapot short and stout\n\n', 'blockquote');
  t.end();
});
